...
xlabel('Czas [s]');
ylabel('Moc');
title('Syga³ sinusoidalny - Obwiednia mocy, \alpha = 0.001');
subplot(4,2,5);
plot(t,signal);
xlabel('Czas [s]');
ylabel('Amplituda');
...
xlabel('Czas [s]');
ylabel('Moc');
title('Sygna³ o zmiennej czêstotliwoœci - Obwiednia mocy, \alpha = 0.001');
subplot(4,2,7);
plot(t,voice);
xlabel('Czas [s]');
ylabel('Amplituda');
...
xlabel('Czas [s]');
ylabel('Moc');
title('Sygna³ mowy - Obwiednia mocy \alpha = 0.001');